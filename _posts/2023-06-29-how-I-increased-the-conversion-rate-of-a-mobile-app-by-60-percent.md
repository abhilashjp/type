...
Hence we decided to make budget range and the BHK type capture part of the first time visitor’s user journey and called it ‘Basic Profiling’.  Once they click on search after selecting thes details, they were taken to a listings page with more refined list of properties as per their requirements. 
